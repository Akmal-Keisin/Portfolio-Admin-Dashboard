...
const breadcrumbs = ref([
    ...
    {
        title: 'Create',
        href: techStackRoute.create().url,
    },
]);
...
const handleSubmit = () => {
    form.post(techStackRoute.store().url);
};
</script>
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <Card>
            <CardHeader>
                <CardTitle>Create Tech Stack Form</CardTitle>
                <CardDescription>
                    Enter your tech stack name and its description to create new
                    tech stack
                </CardDescription>
            </CardHeader>
            <CardContent>
